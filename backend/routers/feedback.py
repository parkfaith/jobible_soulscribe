...
{
  "grammar_analysis": "핵심 문법 구조 2~3가지를 구체적으로 설명 (예: 주어-동사 일치, 분사구문, 가정법 등)",
  "nuance_insights": "이 표현의 문화적·맥락적 뉘앙스와 실제 사용 상황 2~3가지 설명",
  "practice_challenge": "비슷한 패턴의 연습 문장 1개 (영어 문장 + 한국어 번역 포함)"
}"""
